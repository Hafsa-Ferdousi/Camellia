...
describe("Auth Controller", () => {
  ...
  describe("registerUser", () => {
    ...
    test("2. should reject registration when required fields are missing", async () => {
      mockReq.body = {
        username: "newuser",
        email: "new@example.com",
      };
    ...
    test("3. should reject duplicate email or username", async () => {
      mockReq.body = {
        username: "testuser",
        name: "Test User",
        email: "test@example.com",
    ...
    test("4. should reject weak password", async () => {
      mockReq.body = {
        username: "newuser",
        name: "New User",
        email: "new@example.com",
    ...
    test("5. should reject invalid security question", async () => {
      mockReq.body = {
        username: "newuser",
        name: "New User",
        email: "new@example.com",
    ...
    test("6. should handle database errors", async () => {
      mockReq.body = {
        username: "newuser",
        name: "New User",
        email: "new@example.com",
  ...
  describe("loginUser", () => {
    test("7. should login successfully with valid credentials", async () => {
      mockReq.body = {
        email: "test@example.com",
    ...
    test("8. should reject missing email or username", async () => {
      mockReq.body = {
        password: "password",
      };
    ...
    test("9. should reject nonexistent user", async () => {
      mockReq.body = {
    ...
    test("10. should reject incorrect password", async () => {
      mockReq.body = {
        email: "test@example.com",
    ...
    test("11. should reject locked account", async () => {
      mockReq.body = {
        email: "test@example.com",
        password: "password",
      };
    ...
    test("12. should reject unverified email", async () => {
      mockReq.body = {
        email: "test@example.com",
        password: "correctPassword",
      };
    ...
    test("13. should require 2FA when enabled", async () => {
      mockReq.body = {
        email: "test@example.com",
        password: "correctPassword",
      };
  ...
  describe("verifyTwoFactorLogin", () => {
    test("14. should successfully verify 2FA login", async () => {
      mockReq.body = {
    ...
    test("15. should reject invalid temporary token", async () => {
      mockReq.body = {
    ...
    test("16. should reject incorrect token type", async () => {
      mockReq.body = {
    ...
    test("17. should reject user without 2FA enabled", async () => {
      mockReq.body = {
    ...
    test("18. should reject incorrect authentication code", async () => {
      mockReq.body = {
        tempToken: "validToken",
        code: "999999",
      };
    ...
    test("19. should reject missing temp token or code", async () => {
      mockReq.body = {
        tempToken: "token",
      };
  ...
  describe("refreshAccessToken", () => {
    test("20. should refresh access token successfully", async () => {
      mockReq.cookies = {
    ...
    test("21. should reject missing refresh token", async () => {
      mockReq.cookies = {};
    ...
    test("22. should reject invalid refresh token", async () => {
      mockReq.cookies = {
    ...
    test("23. should reject expired refresh token", async () => {
      mockReq.cookies = {
  ...
  describe("logoutUser", () => {
    test("24. should logout successfully", async () => {
      mockReq.cookies = {
    ...
    test("25. should logout even without refresh token", async () => {
      mockReq.cookies = {};
  ...
  describe("getSecurityQuestion", () => {
    test("26. should return security question", async () => {
      mockReq.body = {
    ...
    test("27. should reject missing identifier", async () => {
      mockReq.body = {};
    ...
    test("28. should return fake question for unknown user", async () => {
      mockReq.body = {
  ...
  describe("resetPasswordWithAnswer", () => {
    test("29. should reset password successfully", async () => {
      mockReq.body = {
        identifier: "test@example.com",
        answer: "Fluffy",
    ...
    test("30. should reject missing reset fields", async () => {
      mockReq.body = {
        identifier: "test@example.com",
      };
    ...
    test("31. should reject nonexistent user", async () => {
      mockReq.body = {
    ...
    test("32. should reject incorrect security answer", async () => {
      mockReq.body = {
        identifier: "test@example.com",
        answer: "WrongAnswer",
        password: "NewStrongPass123!",
  ...
  describe("getMe", () => {
    test("33. should return current user profile", async () => {
    ...
    test("34. should not expose sensitive fields", async () => {
      mockReq.user = mockUser;
  ...
  describe("updateProfile", () => {
    test("35. should update profile successfully", async () => {
      mockReq.body = {
        name: "Updated Name",
        phone: "01888888888",
      ...
      expect(mockUser.preferredLanguage).toBe(
        "bn"
      );
    ...
    test("36. should reject invalid preferred language", async () => {
      mockReq.body = {
  ...
  describe("updateDefaultAddress", () => {
    test("37. should update default address", async () => {
      mockReq.body = {
    ...
    test("38. should reject missing address fields", async () => {
      mockReq.body = {
        addressLine: "House",
        district: "Dhaka",
      };
  ...
  describe("deleteAccount", () => {
    test("39. should delete account successfully", async () => {
      mockReq.body = {
        password: "correctPassword",
      };
    ...
    test("40. should reject incorrect password", async () => {
      mockReq.body = {
        password: "wrongPassword",
      };
  ...
  describe("setupTwoFactor", () => {
    test("41. should generate 2FA secret and QR code", async () => {
      mockUser.twoFactorEnabled = false;
    ...
    test("42. should reject when 2FA already enabled", async () => {
      mockUser.twoFactorEnabled = true;
  ...
  describe("verifyTwoFactorSetup", () => {
    test("43. should successfully enable 2FA", async () => {
      mockReq.body = {
        code: "123456",
      };
    ...
    test("44. should reject when setup is not in progress", async () => {
      mockUser.twoFactorTempSecret =
        undefined;
    ...
    test("45. should reject incorrect setup code", async () => {
      mockReq.body = {
        code: "999999",
      };
  ...
  describe("disableTwoFactor", () => {
    test("46. should disable 2FA successfully", async () => {
      mockReq.body = {
        password: "correctPassword",
      };
    ...
    test("47. should reject incorrect password", async () => {
      mockReq.body = {
        password: "wrongPassword",
      };
  ...
  describe("verifyEmailOtp", () => {
    test("48. should successfully verify email OTP", async () => {
      mockReq.body = {
        email: "test@example.com",
        otp: "123456",
      };
    ...
    test("49. should reject missing email or OTP", async () => {
      mockReq.body = {
        email: "test@example.com",
      };
    ...
    test("50. should reject unknown email", async () => {
      mockReq.body = {
        email: "missing@example.com",
        otp: "123456",
      };
    ...
    test("51. should reject expired OTP", async () => {
      mockReq.body = {
        email: "test@example.com",
        otp: "123456",
      };
    ...
    test("52. should reject invalid OTP", async () => {
      mockReq.body = {
        email: "test@example.com",
        otp: "999999",
      };
  ...
  describe("resendEmailOtp", () => {
    test("53. should resend OTP for unverified user", async () => {
      mockReq.body = {
        email: "test@example.com",
      };
    ...
    test("54. should return generic response for unknown email", async () => {
      mockReq.body = {
    ...
    test("55. should return generic response for already verified user", async () => {
      mockReq.body = {
        email: "test@example.com",
      };
    ...
    test("56. should reject missing email", async () => {
      mockReq.body = {};
